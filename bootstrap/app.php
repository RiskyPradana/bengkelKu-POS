...
use App\Http\Middleware\EnsureRoleHasAccess;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        $middleware->alias([
            ...
            // Sesi 11: middleware role di level route (lihat app/Http/Middleware/EnsureRoleHasAccess.php).
            // Menutup celah dimana halaman yang disembunyikan dari sidebar masih
            // bisa dibuka langsung lewat URL oleh role yang tidak berhak.
            'role.access' => EnsureRoleHasAccess::class,
        ]);
